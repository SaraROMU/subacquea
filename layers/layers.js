...
var format_Siti_3 = new ol.format.GeoJSON();
var features_Siti_3 = format_Siti_3.readFeatures(json_Siti_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Siti_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Siti_3.addFeatures(features_Siti_3);
var lyr_Siti_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Siti_3, 
                style: style_Siti_3,
                interactive: true,
                title: '<img src="styles/legend/Siti_3.png" /> Siti'
            });

lyr_ESRIShadedRelief_0.setVisible(true);lyr_Rinvenimentisottomarinisporadici_1.setVisible(false);lyr_Relitti_2.setVisible(false);lyr_Siti_3.setVisible(true);
var layersList = [lyr_ESRIShadedRelief_0,lyr_Rinvenimentisottomarinisporadici_1,lyr_Relitti_2,lyr_Siti_3];
...
lyr_Siti_3.set('fieldAliases', {'ID': 'Numero elenco', 'COOR. Y': 'COOR. Y', 'COOR. X': 'COOR. X', 'SITO': 'Nome', 'SITO_1': 'SITO_1', 'RELITTO': 'RELITTO', 'SPORADICO': 'SPORADICO', 'DATA': 'Data inizio', 'DATA FINE': 'Data fine', 'MERCI ETRUSCHE': 'Merci etrusche', 'MERCI NON ETRUSCHE O DUBBIE': 'Merci non etrusche', 'BIBLIOGRAFIA': 'Bibliografia', 'OSSERVAZIONI/INTERPRETAZIONE DEL RELITTO': 'OSSERVAZIONI/INTERPRETAZIONE DEL RELITTO', });
...
lyr_Siti_3.set('fieldImages', {'ID': 'Range', 'COOR. Y': 'Hidden', 'COOR. X': 'Hidden', 'SITO': 'TextEdit', 'SITO_1': 'Hidden', 'RELITTO': 'Hidden', 'SPORADICO': 'Hidden', 'DATA': 'TextEdit', 'DATA FINE': 'Range', 'MERCI ETRUSCHE': 'TextEdit', 'MERCI NON ETRUSCHE O DUBBIE': 'TextEdit', 'BIBLIOGRAFIA': 'TextEdit', 'OSSERVAZIONI/INTERPRETAZIONE DEL RELITTO': 'Hidden', });
...
lyr_Siti_3.set('fieldLabels', {'ID': 'inline label', 'SITO': 'inline label', 'DATA': 'inline label', 'DATA FINE': 'inline label', 'MERCI ETRUSCHE': 'inline label', 'MERCI NON ETRUSCHE O DUBBIE': 'inline label', 'BIBLIOGRAFIA': 'inline label', });
lyr_Siti_3.on('precompose', function(evt) {
