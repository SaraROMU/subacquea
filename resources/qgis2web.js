...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1992187.176571, 3330654.086812, 4247228.666441, 6854534.694505], maxZoom: 16, minZoom: 3
    })
});
...
map.getView().fit([-1992187.176571, 3330654.086812, 4247228.666441, 6854534.694505], map.getSize());
